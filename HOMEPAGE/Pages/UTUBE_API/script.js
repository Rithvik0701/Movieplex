  ...
  data.forEach((movie) => {
    ...
    movieEl.innerHTML = `
        ...
        <div class="overview">
          <h3>Overview</h3>
          ${overview}
         <form action="http://localhost:3000/api/submitMovie?movieName=${title}" method="post" id="submitForm">
           <button type="submit" class="BOOK_NOW" id="BOOK_NOW">BOOK NOW</button>
         </form>
